...
angular.module('mean.packages').controller('PackageController', ['$scope', '$stateParams', '$location', '$sce', 'Global','Packages', 'marked',
  function($scope, $stateParams, $location, $sce, Global, Packages, marked) {
    $scope.global = Global;
